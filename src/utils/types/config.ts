...
export interface AppConfig {
  ...
  welcomeText?: string;
  /**
   * Comment placed at the top of every YAML document VAYS generates itself
   * (the document seeded when creating an entity). Written as `# <line>`
   * after the `---` document marker; a multi-line value yields one comment
   * line per line, an empty string omits the comment entirely.
   * Defaults to `Automatically generated by VAYS`.
   */
  yamlComment?: string;
  oidcConf: {
    server: string;
