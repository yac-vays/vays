    ...
    <>
      <div
        ...
        className={
          ...
          ` my-1.5 flex items-center justify-center rounded border-[.5px]  ${indicateError ? 'border-danger bg-danger-10' : 'border-stroke bg-primary-10'} px-2.5 py-1.5 text-sm font-medium  dark:bg-white/30`
        }
      >
        <div
