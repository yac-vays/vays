...
import LogoIcon from '../../../../../rsc/logo/logo-icon.png';
...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-50 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-grow items-center justify-between px-4 py-2.5 shadow-2 md:px-6 2xl:px-11">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          <Link className="block flex-shrink-0 lg:hidden" to="/">
            <div className="border-black rounded flex">
              {/* TODO: Revisit this icon, probably size 32 px too? */}
